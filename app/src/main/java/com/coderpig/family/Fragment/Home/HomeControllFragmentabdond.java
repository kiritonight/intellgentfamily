 ...
 */
public class HomeControllFragmentabdond extends  BaseFragement{
    private static final String mTag = HomeControllFragmentabdond.class.getSimpleName();
    ...
    protected View initView() {
        ...
        mineFragmentView = View.inflate(mContext, R.layout.fg_home_controllabdond, null);
